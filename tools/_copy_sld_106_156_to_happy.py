"""Copy Simple Lending Direct rows 106-156 into happy loans (Pending).
...
def main() -> None:
    ...
    for i, raw_row in enumerate(src_rows):
        ...
        # Fill any still-empty mandatory fields with safe defaults
        defaults = {
